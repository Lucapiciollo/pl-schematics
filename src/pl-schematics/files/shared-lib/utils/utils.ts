...
export class  Utils {
   ...
   * Utilizza l'API nativa crypto.randomUUID() (supportata da tutti i browser moderni e da Node.js 16.7+),
   * evitando cosi' la dipendenza da librerie esterne non piu' mantenute.
   */
